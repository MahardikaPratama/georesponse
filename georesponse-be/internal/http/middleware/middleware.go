...
// server logs (BACKEND_ARCHITECTURE.md section 6). This is Chi's built-in
// implementation; it satisfies the requirement without reimplementing it.
var RequestID = chimiddleware.RequestID

// Recovery converts an unexpected panic in a handler into a 500 response
// instead of crashing the process (BACKEND_ARCHITECTURE.md section 6).
// This is Chi's built-in Recoverer.
