 ...
 *                mirroring the backend's rules (id/name required,
 *                latitude in [-90, 90], longitude in [-180, 180],
 *                attributes required per
