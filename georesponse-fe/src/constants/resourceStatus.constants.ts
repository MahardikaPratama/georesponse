 ...
 *                panel) — the same color mapping is used in all three
 *                places, so a status never means one color in one view and
 *                a different color elsewhere.
 ...
 *                        all need, each rebuilding the same
 *                        `Object.keys(...).map(...)` before this.
 */
