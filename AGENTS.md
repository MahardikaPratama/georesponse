...
win. This file exists so an agent has enough context to act correctly without
...
intentionally: many agentic tools only read one or the other, so neither
should assume the other has been read.
